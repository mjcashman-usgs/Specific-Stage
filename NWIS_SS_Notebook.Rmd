...
readNWISrating(siteNumber= Site, "exsa")
```

```{r Download site measurement data}
...
```{r Plot measurement data for both stage and Q}
#Plot unit value discharge & stage
ggplot(data=subset(uvdata), aes(x=dateTime, y=Flow_Inst))+
    ggtitle(paste("USGS ", Site, sitedata$station_nm), subtitle = "Measurements on Instantaneous Unit Q")+
    theme_ss(14,"sans")+
    geom_line(alpha=0.8)+
    ylab("Instantaneous Discharge (cfs)")+
