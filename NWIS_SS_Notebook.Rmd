...
```{r, echo=FALSE, results='hide', message=FALSE, warning=FALSE, fig.height=3, fig.width=5}
...
##Download site measurement data
```{r Download rating curve data}
rating<-readNWISrating(siteNumber= Site, "exsa")
head(rating)
tail(rating)
```
